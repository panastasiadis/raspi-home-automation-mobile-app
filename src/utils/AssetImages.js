...
export const Brightness = BrightnessImage;
export const LightBulbOpen = LightBulbOpenImage;
export const LightBulbClosed = LightBulbClosedImage;
export const Temperature = TemperatureImage;
export const Humidity = HumidityImage;
export const Average = AverageImage;
export const NotFound = NotFoundImage;